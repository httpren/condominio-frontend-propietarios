...
const CrearReservaPage = () => {
  ...
  const validate = useCallback(() => {
    ...
    if (fechaReserva <= ahora) return 'La fecha y hora deben ser futuras';
  ...
  const handleSubmit = useCallback(async (e) => {
    ...
    if (result.success) {
      const message = result.offlinePending 
        ? 'Reserva creada exitosamente (pendiente de sincronizar)' 
  ...
  // Opciones de áreas para el formulario
                    ...
                    {formData.invitados.length > 0 && (
                      <div className="space-y-2 max-h-48 overflow-y-auto custom-scrollbar">
                        ...
                        {formData.invitados.map((inv, i) => (
                          <div key={i} className="flex items-center justify-between bg-white/5 px-4 py-3 rounded-lg backdrop-blur-sm border border-white/10">
          ...
          <div className="space-y-6">
            ...
            <div className="card-minimal space-y-4">
              ...
              <div className="space-y-2 text-green-200/80 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">$50.000/día</span>
                </div>
                <div className="flex justify-between">
                  <span>Piscina:</span>
                  <span className="font-medium">$30.000/día</span>
                </div>
                <div className="flex justify-between">
                  <span>Cancha deportiva:</span>
                  <span className="font-medium">$25.000/día</span>
                </div>
                <div className="flex justify-between">
                  <span>Zona BBQ:</span>
                  <span className="font-medium">$40.000/día</span>
                </div>
                <p className="text-xs pt-2 border-t border-white/10">
                  *Los costos exactos pueden variar según el área y la temporada
                </p>
              </div>
            </div>
            ...
            <div className="card-minimal space-y-4">
              ...
              <div className="space-y-2 text-orange-200/80 text-sm">
                ...
                <p className="text-xs pt-2 border-t border-white/10 text-orange-200/60">
                  Los horarios pueden variar según el área específica
                </p>
              </div>
            </div>
          </div>
